...
const mockTasks: Task[] = [
  ...
  },
  {
    ...
    description: "There are new high-intent leads that consider Google, Apple and HubSpot. Contact them first.",
    priority: "high",
    dueDate: "Today",
  ...
  },
  {
    ...
    description: "Your customer from ACME was interacting with Apple multiple times over the last week. Reach out to John Doe to secure the ongoing deal.",
    priority: "high",
    dueDate: "Today",
    companyName: "ACME",
